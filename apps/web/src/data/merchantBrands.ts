...
export const MERCHANT_BRAND_DEFS: MerchantBrandDef[] = [
  ...
  { id: "shoppers", name: "Shoppers Drug Mart", shortName: "Shoppers", mcc: "5912", category: "other", group: "Shopping", logoDomain: "shoppersdrugmart.ca" },
  ...
  // Entertainment
  { id: "cineplex", name: "Cineplex", mcc: "7832", category: "other", group: "Entertainment", logoDomain: "cineplex.com" },
  { id: "steam", name: "Steam", mcc: "5816", category: "other", group: "Entertainment", logoDomain: "steampowered.com" },
  { id: "xbox", name: "Xbox", mcc: "5816", category: "other", group: "Entertainment", logoDomain: "xbox.com" },
  { id: "playstation", name: "PlayStation", shortName: "PSN", mcc: "5816", category: "other", group: "Entertainment", logoDomain: "playstation.com" },
  { id: "ticketmaster", name: "Ticketmaster", mcc: "7922", category: "other", group: "Entertainment", logoDomain: "ticketmaster.ca", logoDomainFallbacks: ["ticketmaster.com"] },
  { id: "apple_tv", name: "Apple TV+", shortName: "Apple TV+", mcc: "5815", category: "streaming", group: "Entertainment", logoDomain: "apple.com" },
  { id: "ea", name: "EA", mcc: "5816", category: "other", group: "Entertainment", logoDomain: "ea.com" },
  { id: "amc", name: "AMC Theatres", shortName: "AMC", mcc: "7832", category: "other", group: "Entertainment", logoDomain: "amctheatres.com" },

  // Health & pharmacy
  { id: "rexall", name: "Rexall", mcc: "5912", category: "other", group: "Health & pharmacy", logoDomain: "rexall.ca" },
  { id: "london_drugs", name: "London Drugs", shortName: "London Drugs", mcc: "5912", category: "other", group: "Health & pharmacy", logoDomain: "londondrugs.com" },
  { id: "goodlife", name: "GoodLife Fitness", shortName: "GoodLife", mcc: "7997", category: "other", group: "Health & pharmacy", logoDomain: "goodlifefitness.com" },
  { id: "cvs", name: "CVS", mcc: "5912", category: "other", group: "Health & pharmacy", logoDomain: "cvs.com" },
  { id: "walgreens", name: "Walgreens", mcc: "5912", category: "other", group: "Health & pharmacy", logoDomain: "walgreens.com" },
  { id: "peloton", name: "Peloton", mcc: "7997", category: "other", group: "Health & pharmacy", logoDomain: "onepeloton.com" },

  // Transportation
  { id: "uber", name: "Uber", mcc: "4121", category: "other", group: "Transportation", logoDomain: "uber.com" },
  { id: "lyft", name: "Lyft", mcc: "4121", category: "other", group: "Transportation", logoDomain: "lyft.com" },
  { id: "ttc", name: "TTC", mcc: "4111", category: "other", group: "Transportation", logoDomain: "ttc.ca" },
  { id: "presto", name: "Presto", mcc: "4111", category: "other", group: "Transportation", logoDomain: "prestocard.ca" },
  { id: "go_transit", name: "GO Transit", shortName: "GO", mcc: "4111", category: "other", group: "Transportation", logoDomain: "gotransit.com" },
  { id: "via_rail", name: "VIA Rail", shortName: "VIA", mcc: "4112", category: "travel", group: "Transportation", logoDomain: "viarail.ca" },
  { id: "mta", name: "MTA", mcc: "4111", category: "other", group: "Transportation", logoDomain: "mta.info" },
  { id: "clipper", name: "Clipper", mcc: "4111", category: "other", group: "Transportation", logoDomain: "clippercard.com" },

  // Education
  { id: "coursera", name: "Coursera", mcc: "8241", category: "other", group: "Education", logoDomain: "coursera.org" },
  { id: "udemy", name: "Udemy", mcc: "8241", category: "other", group: "Education", logoDomain: "udemy.com" },
  { id: "uoft", name: "University of Toronto", shortName: "U of T", mcc: "8220", category: "other", group: "Education", logoDomain: "utoronto.ca" },
  { id: "mcgill", name: "McGill University", shortName: "McGill", mcc: "8220", category: "other", group: "Education", logoDomain: "mcgill.ca" },
  { id: "ubc", name: "UBC", mcc: "8220", category: "other", group: "Education", logoDomain: "ubc.ca" },
  { id: "khan_academy", name: "Khan Academy", shortName: "Khan", mcc: "8241", category: "other", group: "Education", logoDomain: "khanacademy.org" },
  { id: "linkedin_learning", name: "LinkedIn Learning", shortName: "LinkedIn", mcc: "8241", category: "other", group: "Education", logoDomain: "linkedin.com" },
  { id: "ucla", name: "UCLA", mcc: "8220", category: "other", group: "Education", logoDomain: "ucla.edu" },
  { id: "nyu", name: "NYU", mcc: "8220", category: "other", group: "Education", logoDomain: "nyu.edu" },
