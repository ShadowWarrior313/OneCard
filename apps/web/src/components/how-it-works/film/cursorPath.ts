...
export const CURSOR_KEYS: CursorKey[] = [
  // ── Scene 1: online checkout → "Use Card" button centre (773, 470) ──
  ...
  { t: 4600, x: 600, y: 320 },
  { t: 5600, x: 740, y: 440 },
  { t: 6300, x: 773, y: 470, hand: 1 },
  { t: 6600, x: 773, y: 470, hand: 1, press: 1 },
  { t: 6820, x: 773, y: 470, hand: 1, press: 0 },
  { t: 7200, x: 710, y: 420, hand: 0 },
  { t: 8200, x: 670, y: 390 },
  { t: 9600, x: 670, y: 390, vis: 1 },
  { t: 10200, x: 670, y: 390, vis: 0 },

  // ── Scene 2: tap to pay (cursor hidden) ─────────────────────
  { t: 11000, x: 670, y: 390, vis: 0 },

  // ── Scene 3: routing → winning row centre (500, 252) ────────
  { t: 21000, x: 500, y: 470, vis: 0 },
  { t: 21400, x: 500, y: 470, vis: 1 },
  { t: 23500, x: 520, y: 420 },
  { t: 24600, x: 505, y: 300 },
  { t: 25000, x: 500, y: 252, hand: 1 },
  { t: 25200, x: 500, y: 252, hand: 1, press: 1 },
  { t: 25450, x: 500, y: 252, hand: 1, press: 0 },
  { t: 26200, x: 560, y: 230, hand: 0 },
  { t: 28600, x: 560, y: 230, vis: 1 },
  { t: 29200, x: 560, y: 230, vis: 0 },

  // ── Scene 4: wallet → "Add a card" centre (278, 370) ────────
  { t: 31800, x: 280, y: 320, vis: 0 },
  { t: 32100, x: 280, y: 320, vis: 1 },
  { t: 33000, x: 278, y: 370, hand: 1 },
  { t: 33600, x: 278, y: 370, hand: 1, press: 1 },
  { t: 33850, x: 278, y: 370, hand: 1, press: 0 },
  { t: 34400, x: 380, y: 330, hand: 0 },
  { t: 35600, x: 640, y: 360 },
  { t: 37200, x: 640, y: 360, vis: 1 },
  { t: 37900, x: 640, y: 360, vis: 0 },
];

/** Times the guided cursor clicks — used for ripple haptics (aligned to presses). */
