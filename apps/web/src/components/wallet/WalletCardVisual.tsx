    ...
    return (
      ...
      >
        <div className="flex min-w-0 items-center gap-2">
          <EmvChip />
          <span className="truncate text-[0.55rem] font-bold uppercase tracking-wide">
            {label}
          </span>
        </div>
        <div className="flex shrink-0 items-center gap-1.5">
          {isBusiness && (
            <span className="rounded bg-white/25 px-1 text-[0.45rem] font-bold uppercase">
              Biz
            </span>
          )}
    ...
    >
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-start gap-2">
          <EmvChip />
          <div>
            <p className="text-[0.5rem] font-bold uppercase opacity-90">{card.issuer}</p>
            {tier && (
      ...
      {isBusiness && (
        <span className="absolute bottom-3 right-3 rounded-full bg-white/25 px-2 py-0.5 text-[0.5rem] font-bold uppercase">
          Business
        </span>
      )}
    </div>
