            ...
            >
              ...
              >
                <div className="relative aspect-[1.586] overflow-hidden rounded-[1.25rem] shadow-[0_28px_72px_rgba(0,0,0,0.55)] ring-2 ring-white/20">
                  ...
                  />
                  <div className="relative flex h-full min-h-0 flex-col p-4 text-white sm:p-5">
                    ...
                    <div className="flex min-h-0 flex-1 flex-col justify-center py-2">
                      ...
                      <p
                        className={`mt-1.5 max-w-[92%] font-semibold text-balance ${
                          cardholderName.length > 18
                            ? "text-[0.62rem] leading-[1.2] tracking-[0.03em]"
                            : cardholderName.length > 14
                              ? "text-[0.68rem] leading-[1.22] tracking-[0.04em]"
                              : cardholderName.length > 10
                                ? "text-xs leading-[1.25] tracking-[0.05em]"
                                : "text-sm leading-[1.3] tracking-wide"
                        }`}
                      >
                        {cardholderName}
                      </p>
