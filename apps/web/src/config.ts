...
export interface HubServerConfig {
  ...
  /**
   * Email-only sessions are a local/demo shortcut. They must be explicitly
   * enabled and can never run in production because email alone proves nothing.
   */
